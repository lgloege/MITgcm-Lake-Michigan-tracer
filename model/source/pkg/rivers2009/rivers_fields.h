...
c     USE_RIVERS_INTERPOLATION are undefined, ustress and vstress are
...
c
      ...
      _RL rivflow(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      common /rivers_rivflowt_r1/ rivflow0, rivflow1
      _RL rivflow0(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      _RL rivflow1(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
