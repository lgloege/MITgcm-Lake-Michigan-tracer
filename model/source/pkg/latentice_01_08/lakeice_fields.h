...
c
 ...
 c    modified by Val Bennington to allow for latent heat file 
 c    from ice melt/formation
 c    modified Jan 2008:
 
 	  common /lakeice_icelatent_r/ icelatent
      _RL icelatent(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      common /lakeice_icelatentt_r1/ icelatent0, icelatent1
      _RL icelatent0(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
      _RL icelatent1(1-olx:snx+olx,1-oly:sny+oly,nsx,nsy)
